...
# Entrolics Engineering Node.js REST API Challenge
...
Build a REST API that will allow Entrolics to manage pricing individually on machines remotely with the following:
